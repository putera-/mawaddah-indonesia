/*
  ...
  - You are about to drop the column `endingAt` on the `payment` table. All the data in the column will be lost.
  - You are about to drop the column `startedAt` on the `payment` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `payment` DROP COLUMN `endingAt`,
