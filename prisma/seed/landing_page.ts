...
export async function LandingPageSeed(prisma: PrismaClient) {
    ...
    const main_slides: Prisma.MainSlideCreateManyInput[] = [];
    for (let i = 0; i < 3; i++) {
        main_slides.push({
    ...
    const about: Prisma.AboutCreateInput = {
    ...
    const social_media: Prisma.SocialMediaCreateManyInput[] = [];
