...
export async function LandingPageSeed(prisma: PrismaClient) {
    ...
    for (const soc_med of social_media_list) {
        social_media.push({
            icon,
            url: soc_med.url,
            text: soc_med.label,
